<?php 
define('BOT_TOKEN', '1723005657:AAFm45ldgQGmD0aoWbmmUtYw2EJmV98UDF8'); 
...
*Escolha uma das opções a baixo e clique no botão correspondente.*',
		    'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'➕ Adicione-me a um grupo ➕','url'=>'https://t.me/StarkConsultasbot?startgroup=start')                                           
                                                      ),
                                                     //linha 2
                                                     array(
                                                     ...
                                                     //linha 5
                                                     array(                     
                                                         array('text'=>'👥 Grupo','url'=>'https://t.me/joinchat/Gz9LjyUVoJ3M6EmB'),                                                                                  
                                                         array('text'=>'Canal 📢','url'=>'https://t.me/StarkRefs')                                                 
                                                      ),
                                                     //linha 6
                                                     array(                                               
...
*Escolha uma das opções a baixo e clique no botão correspondente.*',
       ...
       if($data_array['id']==$callback['from']['id']) {  
          ...
          if(!stripos($adms, "StarkConsultasbot")) {         
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                     //linha 1
                                                     array(
                                                         array('text'=>'CONTATO DO VENDEDOR','url'=>'https://t.me/StarkVendasOFC')
                                                      )
...
function processMessage($message) {
    ...
    if (isset($member_name) && $is_bot != '1') {
		if ($member_user !== 'StarkConsultasbot') {
...
Conheça abaixo, todos os meus comandos:*', "reply_to_message_id" => $message_id,
         ...
         } else if($member_user == 'StarkConsultasbot') {
...
*Meu nome é @StarkConsultasbot. Adicione-me em um grupo e me coloque como Admin para utilizar todos os meus recursos!
...
define('WEBHOOK_URL', 'https://vander-checkers-2020.000webhostapp.com/StarkConsultasbot/bot.php');
